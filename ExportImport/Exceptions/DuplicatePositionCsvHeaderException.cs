namespace Skyline.DataMiner.Utils.ExportImport.Exceptions
{
	...
	/// <summary>
	/// Represents an error where duplicate CSV headers are detected.
	/// </summary>
	[Serializable]
	public class DuplicatePositionCsvHeaderException : DuplicateCsvHeaderException
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="DuplicatePositionCsvHeaderException"></see> class.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DuplicatePositionCsvHeaderException"></see> class with a specified error message.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DuplicatePositionCsvHeaderException"></see> class with a specified error message and a reference to the inner exception that is the cause of this exception.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DuplicatePositionCsvHeaderException"></see> class with serialized data.
		/// </summary>
