namespace Skyline.DataMiner.Utils.ExportImport.Exceptions
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="DuplicateHeaderCsvHeaderException"></see> class.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DuplicateHeaderCsvHeaderException"></see> class with a specified error message.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DuplicateHeaderCsvHeaderException"></see> class with a specified error message and a reference to the inner exception that is the cause of this exception.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DuplicateHeaderCsvHeaderException"></see> class with serialized data.
		/// </summary>
